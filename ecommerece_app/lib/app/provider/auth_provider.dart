...
//   final _storedToken = pref.getString('token'); // Fixed variable name
  
//   // Fixed condition: check _storedToken instead of _token
//   if (userJson != null && _storedToken != null) {
//     try {
//       _user = User.fromJson(jsonDecode(userJson));
//       _token = _storedToken; // Fixed assignment
//       _isAuthenticated = true;
//       _isUserVerified = _user!.isVerified; // Fixed assignment
//       notifyListeners();
//     } catch (e) {
...
//     notifyListeners();
//   }
//   print('Auth initialized: $_isAuthenticated, verified: $_isUserVerified');
// }
Future<void> initAuth() async {
  ...
  print('Final state - Authenticated: $_isAuthenticated, Verified: $_isUserVerified');
}
...
Future<bool> getUSerProfileData() async {
  ...
  Future<bool>verifyEmailVerificationCode(email,code)async {
    ...
    try {
      print("Sending verification code to: $email");
      final response = await authService.verifyEmailVerificationCode(email,code);
      if (response['success'] == true) {
...
//     _isAuthenticated = true;
//     _isUserVerified = user.isVerified; // Fixed assignment
//     notifyListeners();
